...
Restart the host after registration, then call `mcp__pascal_mcp__get_compiler_info`. The maintainer workflow remains read-only until the server responds and a supported compiler is listed.
